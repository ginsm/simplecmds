...
const Validate = {
  ...
  /**
    ...
    * @example <caption>String notation for types:</caption>
    * Required types - '<types>'
    * Optional types - '[types]'
    * Types - 'number,boolean,string'
    *
    * Usage:
    * .rule('myCommand', '<number,string> [string]', 3)
    *
    * Explanation:
    * The first argument is required and must be a number or string.
    * The following 2 arguments are optional and must be a string.
    */
